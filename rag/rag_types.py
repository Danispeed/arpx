...
def retrieve_chunks_naive(user_query, chat_id, k_main, k_ref):
    return retrieve_chunks(user_query, chat_id, k_main, k_ref)


def retrieve_chunks_llm_query(user_query, chat_id, k_main, k_ref):
    new_query = generate_search_query(user_query)
    return retrieve_chunks(new_query, chat_id, k_main, k_ref)
...
def retrieve_chunks_fusion(user_query, chat_id, k_main, k_ref):
